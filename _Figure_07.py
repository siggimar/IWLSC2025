...
'''
    This module presents triangulated mesh from brittle screening study from 2025. 
...
def present_model():
    ...
    meshes = [ prep_mesh( f ) for f in files_in_folder( model_folder  ) ]
    ...
    plotter.save_graphic("Figure_07.svg") 
